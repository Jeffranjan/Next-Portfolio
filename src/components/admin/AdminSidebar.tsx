                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            href={item.href}
                            className={cn(
                                "flex flex-col items-center justify-center min-w-[60px] p-2 rounded-lg transition-all duration-200 group text-xs font-mono gap-1 active:scale-95 flex-shrink-0",
                                isActive
