...
import {
  ...
  deleteBlog,
  toggleFeatured,
} from "@/app/admin/(dashboard)/blogs/actions";
...
export default function BlogsTable({ blogs }: BlogsTableProps) {
  ...
  const currentSort = searchParams.get("sort") || "published_at";
        ...
        <table className="w-full text-left text-sm">
          <thead className="bg-[#111] border-b border-[#333] text-gray-400 font-mono uppercase text-xs">
            <tr>
              ...
              <th
                className={cn(
                  "px-6 py-4 font-semibold cursor-pointer select-none group hover:text-gray-200 transition-colors",
                  currentSort === "published_at" && "text-white",
                )}
              ...
              <th
                className={cn(
                  "px-6 py-4 font-semibold text-right cursor-pointer select-none group hover:text-gray-200 transition-colors",
                  currentSort === "views" && "text-white",
                )}
              ...
              blogs.map((blog) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">
                    <button
                      onClick={() =>
                        handleToggleFeatured(blog.id, blog.featured)
                      }
                      className={cn(
